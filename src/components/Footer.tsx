    ...
    <footer className="bg-gray-800 text-white py-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">プロンプトバトル</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/topics" className="text-gray-300 hover:text-white transition">
                  お題一覧
                </Link>
              </li>
              <li>
                <Link href="/battles" className="text-gray-300 hover:text-white transition">
                  対戦履歴
                </Link>
              </li>
              <li>
